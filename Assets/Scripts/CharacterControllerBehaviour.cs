...
public class CharacterControllerBehaviour : MonoBehaviour {
    ...
    private void MovementCalculation()
    {
        ...
        Vector3 correctedHorizontal = _horizontalInput * Camera.main.transform.right;
        Vector3 correctedVertical = _verticalInput * Camera.main.transform.forward;
    ...
    private void Sprinting()
    {
        ...
        //Make toad able to sprint, slighty increasing his movement speed when a set button is being held down (B | A | X) - (1 | 0 | 2)
        if(_inputAmount> 0 && ( Input.GetButton("Fire1")|| Input.GetButton("Fire2") || Input.GetButton("Fire3")))
        {
